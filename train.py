...
Y_data = np.zeros((len(train_ids), IMG_HEIGHT, IMG_WIDTH, 1), dtype=np.bool)
...
train_generator, val_generator, X_train, X_val, Y_train, Y_val = get_train_val_augmented(X_data=X_data, Y_data=Y_data,
